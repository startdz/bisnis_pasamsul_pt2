    ...
    <div className="container mx-auto lg:max-w-6xl">
     ...
     <div className="grid grid-cols-2 gap-2 pt-4 md:grid-cols-3 md:gap-3 lg:flex lg:justify-evenly lg:flex-wrap">
        ...
        <div className="aspect-square rounded border p-1 shadow-lg group sm:p-2">
            <img src={y3} alt="product" className="rounded-md border-b group-hover:scale-95 group-hover:rotate-3 transition-all duration-500 ease-in-out w-full" />
            <div className="border-t mt-2 flex justify-between">
                ...
                <div className="font-bold text-sm flex flex-col justify-between text-end sm:text-base lg:text-lg">
                    <div className="truncate border-b">Title Others Product</div>
            ...
            <div className="flex justify-between mt-4 flex-row-reverse font-bold border-t pt-2 text-center sm:p-2">
                <Link className="px-4 py-2 bg-zinc-800 text-base-100 rounded hover:bg-zinc-900 hover:rounded-md transition-all duration-300 ease-in-out hover:text-sm">Hapus</Link>
                <Link className="px-4 py-2 bg-zinc-800 text-base-100 rounded hover:bg-zinc-900 hover:rounded-md transition-all duration-300 ease-in-out hover:text-sm">Ubah</Link>
            </div>
        </div>
        <div className="aspect-square rounded border p-1 shadow-lg group sm:p-2">
            <img src={y3} alt="product" className="rounded-md border-b group-hover:scale-95 group-hover:rotate-3 transition-all duration-500 ease-in-out w-full" />
