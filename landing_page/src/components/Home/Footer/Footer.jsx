    ...
    return (
        <React.Fragment>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    <span className="footer-title">Page</span>
                ...
                <div>
                    <span className="footer-title">Mitra</span>
                    <a className="link link-hover">Lokasi Bogor</a>
                    <a className="link link-hover">Lokasi Cianjur</a>
                    <a className="link link-hover">Lokasi Sukabumi</a>
                    <a className="link link-hover">Lokasi Jakarta</a>
                </div>
                <div>
                    <span className="footer-title">Kontak</span>
                    <a className="link link-hover">WhatsApp Business</a>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>📌 <span className='uppercase font-semibold'>Alamat Pusat,</span> <br />Perum FKH IPB KP.Kauman, Cikampak Block C12 RT 1/9. Bojongrangkas, Bogor 16620 </p>
                </div>
